...
namespace Java2Dotnet.Spider.Validation
{
	...
	{
		public RangeValidate(IDbConnection conn, string sql, string arguments, string description, ValidateLevel level = ValidateLevel.Error) : base(conn, sql, arguments, description, level)
		{
		}
